...
pgs_methods <- c("real_african_ols_rank_no", "PGS001929_rank", "pgs_average_rank")
...
method_colors <- c(
  ...
  "RA method: Nuclear Norm ams_rank" = "#4169E1", 
...
plot
ggsave("AMS_INCLUDED_Height_OG_Top_Percentiles.png", plot = plot, width = 10, height = 8, dpi = 300)
