...
BMI_summary <- read_csv("R4_BMI_summary_standardized_differences_and_rr_across_groups.csv")
...
plot
ggsave("R4_BMI_OG_Top_Percentiles.png", plot = plot, width = 10, height = 8, dpi = 300)
