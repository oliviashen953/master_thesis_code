R4_AGE_Sample3000_new_supervised_BMI_model_coefficients <- readRDS("~/R4_AGE_Sample3000_new_supervised_BMI_model_coefficients.rds")
new_supervised_BMI_model_coefficients <- R4_AGE_Sample3000_new_supervised_BMI_model_coefficients
library(readr)
...
for(group in 1:20) {
  ...
  file_name <- sprintf("AGE_R4_new_BMI_group%d_with_ranks.csv", group)
  ...
  output_file_name <- sprintf("AGE_R4_new_BMI_group%d_with_ranks.csv", group)
