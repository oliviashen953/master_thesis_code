...
for (group_id in 1:20) {
  file_name <- sprintf("R4_BMI_group%d_standardized_differences_and_rr.csv", group_id)
...
write_csv(summary_results, "R4_BMI_summary_standardized_differences_and_rr_across_groups.csv")
