library(readr)
R4_AGE_Sample3000_new_supervised_T2D_model_coefficients <- readRDS("~/R4_AGE_Sample3000_new_supervised_T2D_model_coefficients.rds")


new_supervised_T2D_model_coefficients <- R4_AGE_Sample3000_new_supervised_T2D_model_coefficients
...
for(group in 1:20) {
  ...
  file_name <- sprintf("AGE_R4_new_T2D_group%d_with_ranks.csv", group)
  ...
  output_file_name <- sprintf("AGE_R4_new_T2D_group%d_with_ranks.csv", group)
