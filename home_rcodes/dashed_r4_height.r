...
method_colors <- c(
  ...
  "NNM" = "#377EB8",
  "AVG_RA_Rank" = "#4DAF4A",
  "Supervised_OLS" = "#FF7F00",
  "Supervised_Best: PGS002332" = "#984EA3",
  "AVG_PRS" = "#FFFF33"
)
...
plot
ggsave("dashed_r4_older_Height_Top_Percentiles.png", plot = plot, width = 10, height = 8, dpi = 300)
