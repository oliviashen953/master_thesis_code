...
pgs_methods <- c("real_african_ols_rank_no", "PGS002313_rank", "pgs_average_rank")
...
plot
ggsave("AMS_INCLUDED_BMI_OG_Top_Percentiles.png", plot = plot, width = 10, height = 8, dpi = 300)
