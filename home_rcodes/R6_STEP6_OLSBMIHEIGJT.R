R6_TIE_Sample3000_new_supervised_BMI_model_coefficients <- readRDS("~/R6_TIE_Sample3000_new_supervised_BMI_model_coefficients.rds")
new_supervised_BMI_model_coefficients <- R6_TIE_Sample3000_new_supervised_BMI_model_coefficients
library(readr)
...
for(group in 1:20) {
  ...
  file_name <- sprintf("TIE_R6_new_BMI_group%d_with_ranks.csv", group)
  ...
  output_file_name <- sprintf("TIE_R6_new_BMI_group%d_with_ranks.csv", group)
