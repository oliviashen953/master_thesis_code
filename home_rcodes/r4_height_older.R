...
pgs_labels <- setNames(c(
  ...
  "AVG_RA_Rank",
  "Supervised_OLS",
  "Supervised_Best: PGS002332_rank",
  "AVG_PRS"
), all_methods)
...
method_colors <- c(
  ...
  "Supervised_Best: PGS002332_rank" = "#984EA3", # Purple
...
plot
ggsave("r4_older_Height_Top_Percentiles.png", plot = plot, width = 10, height = 8, dpi = 300)
