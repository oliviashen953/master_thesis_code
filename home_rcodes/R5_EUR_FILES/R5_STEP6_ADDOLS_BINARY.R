library(readr)
R5_EUR_Sample3000_new_supervised_BrC_model_coefficients <- readRDS("~/R5_EUR_Sample3000_new_supervised_BrC_model_coefficients.rds")


new_supervised_BrC_model_coefficients <- R5_EUR_Sample3000_new_supervised_BrC_model_coefficients
...
for(group in 1:20) {
  ...
  file_name <- sprintf("EUR_R5_new_BrC_group%d_with_ranks.csv", group)
  ...
  output_file_name <- sprintf("EUR_R5_new_BrC_group%d_with_ranks.csv", group)
