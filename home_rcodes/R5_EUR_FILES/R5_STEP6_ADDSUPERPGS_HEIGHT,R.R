R5_EUR_Sample3000_new_supervised_T2D_model_coefficients <- readRDS("~/R5_EUR_Sample3000_new_supervised_T2D_model_coefficients.rds")
new_supervised_T2D_model_coefficients <- R5_EUR_Sample3000_new_supervised_T2D_model_coefficients
library(readr)
...
for(group in 1:20) {
  ...
  new_supervised_T2D_model_coefficients <- R5_EUR_Sample3000_new_supervised_T2D_model_coefficients
  coefficients  <- new_supervised_T2D_model_coefficients
  

  pgs_columns <- names(coefficients)[-1] 
  
  file_name <- sprintf("EUR_R5_new_T2D_group%d_with_ranks.csv", group)
  ...
  output_file_name <- sprintf("EUR_R5_new_T2D_group%d_with_ranks.csv", group)
